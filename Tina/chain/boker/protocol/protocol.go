...
var (
	...
	ErrLoadConfig                 = errors.New("load tinachain config error")                     //加载配置信息出错
	ErrNotFoundAddress            = errors.New("not found tinachain contract address")            //没有找到合约地址
	ErrNotFoundType               = errors.New("not found tinachain contract type")               //没有找到合约类型
	ErrWriteJson                  = errors.New("write tinachain json file error")                 //写保存基础合约的Json格式出错
	ErrOpenFile                   = errors.New("open tinachain json file error")                  //打开基础合约保存文件出错
	ErrWriteFile                  = errors.New("tinachain write file error")                      //写基础合约保存文件出错
	ErrContractExist              = errors.New("tinachain contract aleady exist")                 //写基础合约保存文件出错
	ErrSystem                     = errors.New("system error")                                    //系统错误
	ErrNotFoundContract           = errors.New("not found tinachain contract")                    //没有找到合约
	ErrNotFoundAccount            = errors.New("not found tinachain account")                     //没有找到合约
	ErrNewContractService         = errors.New("create tinachain base contract err")              //没有找到合约
